<template>
	<view style="margin-top: 50rpx; padding:0 30rpx 0 30rpx;">
		<view class="flex align-center">
			<view class="flex justify-between align-center common_topbox" @click="showBill">
				<view class="flex align-center">
		...
		<view style="margin-right: 60rpx;">
			<text class="module_title" style="margin: 0;">日程安排</text>
			<view class="module_underline" style="width: 128rpx;margin: 0;"></view>
		</view>
		...
		<button class="round mxc_sharebtn flex flex-direction align-center justify-center" @click="gotoshare">
			<text class="texticon" style="margin: 0;font-size: 12px;">&#xe61d;</text>
			<text>分享</text>
		</button>
	</view>
</template>
